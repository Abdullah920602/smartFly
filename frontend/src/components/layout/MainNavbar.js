      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav ms-auto">
            ...
            {/* لوحة تحكم شركة الطيران - تظهر فقط للشركات */}
            {user?.role === 'airline' && (
              <li className="nav-item">
                <Link className="nav-link" to="/airline-dashboard" style={{ transition: 'var(--smooth-transition)' }}>
                  <i className="fas fa-tachometer-alt me-1"></i> لوحة التحكم
                </Link>
              </li>
            )}
            ...
            {user ? (
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdownMenuLink">
                  {/* داش بورد تظهر فقط لشركات الطيران */}
                  {user?.role === 'airline' && (
                    <li>
